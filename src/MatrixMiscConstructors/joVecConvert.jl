...
joReal(m::Integer=1,ODT::DataType=Int8,CDT::DataType=Float64) =
...
joImag(m::Integer=1,ODT::DataType=Int8,CDT::DataType=Float64) =
...
joConj(m::Integer=1,ODT::DataType=Int8,DDT::DataType=Float64) =
